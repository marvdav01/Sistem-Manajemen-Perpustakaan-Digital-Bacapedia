...
<head>
    ...
    <title>Register - {{ config('app.name', 'Bacapedia') }}</title>
    ...
    <style>
        body {
            ...
            background-image: radial-gradient(circle at top left, #e0e7ff, transparent),
                              radial-gradient(circle at bottom right, #f3e8ff, transparent);
...
<body class="antialiased text-slate-800 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-500 font-medium">Create an account to start borrowing books.</p>
        </div>
        ...
        <div class="glass-panel rounded-3xl p-8 sm:p-10">
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label for="nama" class="block text-sm font-semibold text-slate-700 mb-1">Full Name</label>
                ...
                <button type="submit" class="w-full mt-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-3 px-4 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5">
                    Sign up
                </button>
            </form>
